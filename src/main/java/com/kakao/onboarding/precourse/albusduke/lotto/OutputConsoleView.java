...
public class OutputConsoleView {
    ...
    public void outputPurchaseAmount(PurchasedLottoCountDto dto) {
        System.out.printf(PURCHASE_COUNT_FORMAT, dto.count());
    }

    public void outputLottoNumbers(LottoNumberListDto dto) {
        for (LottoNumbers lottoNumbers : dto.lottoNumbersList()) {
